...
<!-- Hero Section -->
<section class="relative pt-40 pb-28 md:pt-52 md:pb-40 bg-cover bg-center overflow-hidden" style="background-image: url('{{ asset('assets/images/final-header.jpg') }}');">
