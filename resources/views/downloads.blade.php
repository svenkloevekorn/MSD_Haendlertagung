            ...
            <div class="space-y-4">
                <div class="flex items-center gap-4 p-5 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <div class="flex-1 min-w-0">
                        <h3 class="font-medium text-gray-900 text-sm">Sales Insights – Präsentation</h3>
                        <p class="text-xs text-gray-400 mt-0.5">PDF · wird nach dem Event bereitgestellt</p>
                    </div>
                    <span class="text-xs text-gray-400 bg-gray-100 px-3 py-1 rounded-full">Demnächst</span>
                </div>
                ...
                <div class="flex items-center gap-4 p-5 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <div class="flex-1 min-w-0">
                        <h3 class="font-medium text-gray-900 text-sm">Competitive Analysis</h3>
                        <p class="text-xs text-gray-400 mt-0.5">PDF · wird nach dem Event bereitgestellt</p>
                    </div>
                    <span class="text-xs text-gray-400 bg-gray-100 px-3 py-1 rounded-full">Demnächst</span>
                </div>
                ...
                <div class="flex items-center gap-4 p-5 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <div class="flex-1 min-w-0">
                        <h3 class="font-medium text-gray-900 text-sm">Service Report</h3>
                        <p class="text-xs text-gray-400 mt-0.5">PDF · wird nach dem Event bereitgestellt</p>
                    </div>
                    <span class="text-xs text-gray-400 bg-gray-100 px-3 py-1 rounded-full">Demnächst</span>
                </div>
                ...
                <div class="flex items-center gap-4 p-5 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <div class="flex-1 min-w-0">
                        <h3 class="font-medium text-gray-900 text-sm">Trends & Developments – Guest Speakers</h3>
                        <p class="text-xs text-gray-400 mt-0.5">PDF · wird nach dem Event bereitgestellt</p>
                    </div>
                    <span class="text-xs text-gray-400 bg-gray-100 px-3 py-1 rounded-full">Demnächst</span>
                </div>
