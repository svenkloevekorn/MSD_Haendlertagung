...
<body class="font-sans text-gray-800 antialiased">
    ...
    <nav class="fixed top-0 w-full bg-white/95 backdrop-blur-sm border-b border-gray-100 z-50">
        <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
                ...
                <a href="{{ route('market-info') }}" class="text-gray-900">Market Info</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-gray-100 bg-white">
            <div class="px-6 py-4 flex flex-col gap-3 text-sm font-medium text-gray-600">
                <a href="{{ route('startseite') }}">Home</a><a href="{{ route('agenda') }}">Agenda</a><a href="{{ route('formular') }}">Registration</a><a href="{{ route('market-info') }}" class="text-gray-900">Market Info</a><a href="{{ route('galerie') }}">Gallery</a><a href="{{ route('downloads') }}">Downloads</a><a href="{{ route('feedback') }}">Feedback</a><a href="{{ route('kontakt') }}">Contact</a>
    ...
    <section class="pt-32 pb-16 md:pt-40 md:pb-20 bg-gradient-to-br from-gray-50 to-white">
        <div class="max-w-6xl mx-auto px-6">
            <p class="text-sm font-semibold uppercase tracking-widest text-gray-400 mb-4">Your Market</p>
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Market Info</h1>
            <p class="text-lg text-gray-500 max-w-2xl">Help us understand your market better. Your insights are valuable for our strategy.</p>
        </div>
    </section>
