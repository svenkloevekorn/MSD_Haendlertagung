        ...
        return [
            ...
            Action::make('exportMarketInfo')
                ...
                ->action(fn (): StreamedResponse => self::exportForm(
                    ...
                    'market-info',
                    ['First Name', 'Last Name', 'Delegated to', 'Number of Corrugators', 'Total Belt Market Size (m²)', 'Machine Width < 2.2 m %', 'Machine Width 2.2-2.4 m %', 'Machine Width 2.5-2.7 m %', 'Machine Width 2.8-3.0 m %', 'Machine Width > 3.0 m %', 'Machine Speed < 60 m/min', 'Machine Speed 60-100 m/min', 'Machine Speed 100-150 m/min', 'Machine Speed 150-200 m/min', 'Machine Speed 200-300 m/min', 'Machine Speed > 300 m/min', 'Owner Groups %', 'Owner Independents %', 'MS Share %', 'Competitor A Name', 'Competitor A %', 'Competitor B Name', 'Competitor B %', 'Competitor C Name', 'Competitor C %', 'Others %', 'Order Situation', 'Price Level', 'Capacity Utilization', 'Machine Investments', 'Role of Large Groups', 'SWOT Strengths', 'SWOT Weaknesses', 'SWOT Opportunities', 'SWOT Threats'],
                    ['first_name', 'last_name', 'delegated_to', 'number_of_corrugators', 'total_belt_market_size_m2', 'machine_width_lt_22', 'machine_width_22_24', 'machine_width_25_27', 'machine_width_28_30', 'machine_width_gt_30', 'machine_speed_lt_60', 'machine_speed_60_100', 'machine_speed_100_150', 'machine_speed_150_200', 'machine_speed_200_300', 'machine_speed_gt_300', 'owner_groups_pct', 'owner_independents_pct', 'ms_market_share_pct', 'competitor_a_name', 'competitor_a_pct', 'competitor_b_name', 'competitor_b_pct', 'competitor_c_name', 'competitor_c_pct', 'others_market_share_pct', 'order_situation', 'price_level', 'capacity_utilization', 'machine_investments', 'role_of_large_groups', 'swot_strengths', 'swot_weaknesses', 'swot_opportunities', 'swot_threats'],
                )),
